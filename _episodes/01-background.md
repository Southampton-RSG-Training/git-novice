...
![Introduction](../fig/slides/1_0_introduction.png){:width="20%"}
![What is Version Control?](../fig/slides/1_1_what_does_it_do.png){:width="20%"}
...
![Why Use Version Control? #1](../fig/slides/1_2_why_use.png){:width="20%"}
...
![Why Use Version Control? #2](../fig/slides/1_4_why_teamwork.png){:width="20%"}
...
![Changes are tracked sequentially](../fig/slides/1_5_track_changes.png){:width="20%"}
...
![Different versions can be saved](../fig/slides/1_6_different_versions.png){:width="20%"}

Once you think of **changes as separate from the document** itself, you can then think about "playing back" different sets of changes onto the base document and getting different versions of the document. For example, **two users can make independent sets of changes** based on the same document.

![Multiple versions can be merged](../fig/slides/1_7_merge.png){:width="20%"}
...
![Version Control Alternatives](../fig/slides/1_8_alternatives.png){:width="20%"}
...
![Graphical User Interfaces](../fig/slides/1_9_guis.png){:width="20%"}
